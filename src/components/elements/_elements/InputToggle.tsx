  ...
  return (
    ...
    >
      ...
      <input
        ...
        {...otherProps}
      />
      <div className="relative peer w-[2.3em] h-[1.15em] bg-[#949FA6] rounded-full after:content-[''] after:absolute after:bg-white after:rounded-full after:transition-all after:h-[80%] after:aspect-square after:left-[0.1em] after:top-2/4 after:-translate-y-2/4 peer-checked:after:right-[0.1em] peer-checked:after:left-[auto]  peer-checked:bg-[#63C367]"></div>
