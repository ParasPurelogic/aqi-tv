...
const SearchBar = (props: Props) => {
  ...
  return (
    <div
      className={cn(
        `search-bar w-full p-[0.8em] flex gap-[0.6em] items-center border rounded-[0.7em] text-[#667580] text-[1.2rem] bg-white focus-within:border-primary focus-within:shadow-[0_0_0_1px_#4ba9ff]`,
        props.className
      )}
    >
      {/* Icon */}
