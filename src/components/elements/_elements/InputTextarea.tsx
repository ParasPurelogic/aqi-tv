  ...
  return (
    <div className={cn("input-text relative", className)}>
      ...
      <textarea
        ref={ref}
        className={cn(
          `min-h-[15rem] ${theme.input.text.bgColor} ${theme.input.text.borderColor} ${theme.input.text.borderRadius} ${theme.input.text.borderWidth} ${theme.input.text.placeholderColor} ${theme.input.text.px} ${theme.input.text.py} ${theme.input.commonStyling}`,
          inputClassName,
